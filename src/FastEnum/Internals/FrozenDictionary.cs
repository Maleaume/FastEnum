...
namespace FastEnumUtility.Internals
{
    ...
    internal interface IFrozenDictionary<TKey, TValue>
    {
        IFrozenDictionary<TKey, TValue> Create(IEnumerable<TValue> source, Func<TValue, TKey> keySelector);
        IFrozenDictionary<TKey, TValue> Create<TSource>(IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector);
    ...
    /// </remarks>
    internal class FrozenDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>
    {
        #region Constants
        protected static readonly Func<TValue, TValue> PassThrough = x => x;
        #endregion
        ...
        protected FrozenDictionary(int bucketSize, float loadFactor)
        {
    ...
    /// </remarks>
    internal sealed class FrozenStringKeyDictionary<TValue> : FrozenDictionary<string, TValue>
    {
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenStringKeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    }
    ...
    /// </remarks>
    internal sealed class FrozenSByteKeyDictionary<TValue> : FrozenDictionary<sbyte, TValue>
    {
        /// <summary>
        /// Creates instance.
        /// </summary>
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenSByteKeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
    ...
    /// </remarks>
    internal sealed class FrozenByteKeyDictionary<TValue> : FrozenDictionary<byte, TValue>
    {
        #region Constructors
        /// <summary>
        /// Creates instance.
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenByteKeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    ...
    /// </remarks>
    internal sealed class FrozenInt16KeyDictionary<TValue> : FrozenDictionary<short, TValue>
    {
        #region Constructors
        /// <summary>
        /// Creates instance.
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenInt16KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    ...
    /// </remarks>
    internal sealed class FrozenUInt16KeyDictionary<TValue> : FrozenDictionary<ushort, TValue>
    {
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenUInt16KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    ...
    /// </remarks>
    internal sealed class FrozenInt32KeyDictionary<TValue> : FrozenDictionary<int, TValue>
    {
        #region Constructors
        /// <summary>
        /// Creates instance.
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenInt32KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
    ...
    /// </remarks>
    internal sealed class FrozenUInt32KeyDictionary<TValue> : FrozenDictionary<uint, TValue>
    {
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenUInt32KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    }
    ...
    /// </remarks>
    internal sealed class FrozenInt64KeyDictionary<TValue> : FrozenDictionary<long, TValue>
    {
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenInt64KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    }
    ...
    /// </remarks>
    internal sealed class FrozenUInt64KeyDictionary<TValue> : FrozenDictionary<ulong, TValue>
    {
        ...
        /// <param name="bucketSize"></param>
        /// <param name="loadFactor"></param>
        private FrozenUInt64KeyDictionary(int bucketSize, float loadFactor) : base(bucketSize, loadFactor) { }
        #endregion
    }
